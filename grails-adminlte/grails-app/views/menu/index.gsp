		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Receita x Despesa</h3>
					</div>
					<div class="box-body">
						<div class="chart">
							<canvas id="areaChart" style="height: 300px"></canvas>
							<%--<canvas width="778" height="389" style="width: 778px; height: 389px;" id="areaChart"></canvas>--%>
			...
			<div class="col-md-4">
				<div class="box box-danger">
					<div class="box-header with-border">
						<h3 class="box-title">Gastos por tipo</h3>
					</div>
					<div class="box-body">
